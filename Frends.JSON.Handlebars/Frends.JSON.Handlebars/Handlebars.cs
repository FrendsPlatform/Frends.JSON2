...
using Frends.JSON.Handlebars.Helpers;
...
public static class JSON
{
    ...
    public static Result Handlebars([PropertyTab] Input input, [PropertyTab] Options options, CancellationToken cancellationToken)
    {
        try
        {
